...
export function findAll9(http: HttpClient, rootUrl: string, params?: FindAll9$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<ConsultationDto>>> {
