...
export function findAll8(http: HttpClient, rootUrl: string, params?: FindAll8$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<FactureDto>>> {
