...
import { delete3 } from '../fn/perscription/delete-3';
import { Delete3$Params } from '../fn/perscription/delete-3';
import { findAll3 } from '../fn/perscription/find-all-3';
import { FindAll3$Params } from '../fn/perscription/find-all-3';
import { findById3 } from '../fn/perscription/find-by-id-3';
import { FindById3$Params } from '../fn/perscription/find-by-id-3';
import { PerscriptionDto } from '../models/perscription-dto';
import { save3 } from '../fn/perscription/save-3';
import { Save3$Params } from '../fn/perscription/save-3';

@Injectable({ providedIn: 'root' })
export class PerscriptionService extends BaseService {
  constructor(config: ApiConfiguration, http: HttpClient) {
    super(config, http);
  }

  /** Path part for operation `findAll3()` */
  static readonly FindAll3Path = '/perscriptions/';
   ...
   */
  findAll3$Response(params?: FindAll3$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<PerscriptionDto>>> {
   ...
   * This method doesn't expect any request body.
   */
  findAll3(params?: FindAll3$Params, context?: HttpContext): Observable<Array<PerscriptionDto>> {
    return this.findAll3$Response(params, context).pipe(
      map((r: StrictHttpResponse<Array<PerscriptionDto>>): Array<PerscriptionDto> => r.body)
    );
  }

  /** Path part for operation `save3()` */
  static readonly Save3Path = '/perscriptions/';
  ...
  static readonly FindById3Path = '/perscriptions/{id}';
   ...
   * This method doesn't expect any request body.
   */
  findById3$Response(params: FindById3$Params, context?: HttpContext): Observable<StrictHttpResponse<PerscriptionDto>> {
   ...
   * This method doesn't expect any request body.
   */
  findById3(params: FindById3$Params, context?: HttpContext): Observable<PerscriptionDto> {
    return this.findById3$Response(params, context).pipe(
      map((r: StrictHttpResponse<PerscriptionDto>): PerscriptionDto => r.body)
    );
  }

  /** Path part for operation `delete3()` */
  static readonly Delete3Path = '/perscriptions/{id}';
